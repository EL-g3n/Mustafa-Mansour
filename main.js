...
function flipBlock(selectedBlock) {
    ...
    if (allCardsIsMatched.length === 20) {
        ...
        if (yourName == null || yourName == "") {
            document.querySelector('.modal-content p').innerHTML = 'Congrats, Anonym 👏, You Won The Game But After ' + numberOfWrongTries + ' Wrong Tries.🙄<br>So You Have To Do The Best! Go Ahead To Play Again! 😘'
        } else {
            document.querySelector('.modal-content p').innerHTML = 'Congrats, ' + yourName + ' 👏, You Won The Game But After ' + numberOfWrongTries + ' Wrong Tries.🙄<br>So You Have To Do The Best! Go Ahead To Play Again! 😘'
        }
